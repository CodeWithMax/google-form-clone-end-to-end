...
export default function AlertDialog({docID}) {
  console.log(docID);
             ...
             <input type="checkbox" style={{marginRight:"10px"}}/> Included form in Email
              ...
              <div className="tab_two" style={{  display:"flex",flexDirection:"column",marginTop:"20px",marginBottom:"20px"}}>
                  ...
                  <input type="text" className="tab_input" 
                   ...
                   placeholder="<iframe src='http://localhost:3000/questionPaper/${id}'  height='500px' width='1400px'></iframe>"
                  />
                
              </div>

              <div className="tab_two" style={{  display:"flex",flexDirection:"column",marginTop:"20px",marginBottom:"20px"}}>
                  <div className="tab_text" style={{marginBottom:"8px"}}>Form ID --- {docID}</div>
